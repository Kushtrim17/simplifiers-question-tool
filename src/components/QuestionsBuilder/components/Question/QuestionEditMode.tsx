...
export function QuestionEditMode(props: Props) {
  ...
  const handleAutomationRuleTypeChange = (ruleType: RuleType) => {
    if (question.automationRule) {
      onQuestionUpdate({
        ...question,
        automationRule: { ...question.automationRule, ruleType },
      });
    }
  };
  ...
  return (
    <div className="w-full flex flex-col mr-40">
      ...
      <AutomationRulesSelector
        ...
        onRuleTypeChange={handleAutomationRuleTypeChange}
