...
type Props = {
  ...
  onAddRule: () => void;
  onDeleteRule: () => void;
  onDataSourceToggle: (dataSource: DataSourceOption, checked: boolean) => void;
...
const DATA_SOURCE_OPTIONS: { value: DataSourceOption; label: string }[] = [
    ...
    <div>
      ...
      {rule && (
        <div className="mt-4 p-4 border rounded-lg bg-gray-50">
          ...
          <div className="mb-4">
            <Small className="font-semibold mb-2 block">Data Sources</Small>
            <div className="flex flex-col gap-2">
              {DATA_SOURCE_OPTIONS.map((option) => (
                <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={rule.dataSources.includes(option.value)}
                    onChange={(e) => onDataSourceToggle(option.value, e.target.checked)}
                  />
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: string) =>
                              onConditionChange(conditionType, "matchMode", value as MatchMode)
                            }
                          >
                            <SelectTrigger>
