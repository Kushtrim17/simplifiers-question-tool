...
import { CategoryItemCollapsed } from "./CategoryItemCollapsed";
import { CategoryItemReadOnly } from "./CategoryItemReadOnly";
...
export function CategoryItem(props: Props) {
  ...
  if (isCategoryCollapsed) {
    return <CategoryItemCollapsed category={category} />;
  }
